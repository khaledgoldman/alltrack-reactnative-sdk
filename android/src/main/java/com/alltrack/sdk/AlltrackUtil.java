...
final class AlltrackUtil {
    ...
    public static WritableMap attributionToMap(AlltrackAttribution attribution) {
    ...
    public static WritableMap eventSuccessToMap(AlltrackEventSuccess eventSuccess) {
        WritableMap map = Arguments.createMap();
    ...
    public static WritableMap eventFailureToMap(AlltrackEventFailure eventFailure) {
        WritableMap map = Arguments.createMap();
    ...
    public static WritableMap sessionSuccessToMap(AlltrackSessionSuccess sessionSuccess) {
        WritableMap map = Arguments.createMap();
    ...
    public static WritableMap sessionFailureToMap(AlltrackSessionFailure sessionFailure) {
        WritableMap map = Arguments.createMap();
    ...
    public static Map<String, Object> toMap(@Nullable ReadableMap readableMap) {
        ...
        while (iterator.hasNextKey()) {
            ...
            if (value == null) {
                AlltrackFactory.getLogger().warn("Null parameter inside key-value pair with key: " + key);
                continue;
            }
        ...
        for (int index = 0; index < readableArray.size(); index++) {
            ...
            switch (readableType) {
                ...
                case Array: 
                    ...
                    break; 
                default: 
                    AlltrackFactory.getLogger().error("Could not convert object with index: " + index + ".");
            } 
        } 
    ...
    private static Object toObject(@Nullable ReadableMap readableMap, String key) {
        ...
        switch (readableType) {
            ...
            case Array: 
                ...
                break; 
            default: 
                AlltrackFactory.getLogger().error("Could not convert object with key: " + key + ".");
        }
