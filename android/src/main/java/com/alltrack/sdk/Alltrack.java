package com.alltrack.nativemodule;
...
import com.alltrack.sdk.*;

public class Alltrack extends ReactContextBaseJavaModule implements LifecycleEventListener,
    ...
    public Alltrack(ReactApplicationContext reactContext) {
        super(reactContext);
    }
    ...
    public void onHostPause() {
        com.alltrack.sdk.Alltrack.onPause();
    }

    @Override
    public void onHostResume() {
        com.alltrack.sdk.Alltrack.onResume();
    }
    ...
    public void onAttributionChanged(AlltrackAttribution attribution) {
        sendEvent(getReactApplicationContext(), "alltrack_attribution", AlltrackUtil.attributionToMap(attribution));
    }

    @Override
    public void onFinishedEventTrackingSucceeded(AlltrackEventSuccess event) {
        sendEvent(getReactApplicationContext(), "alltrack_eventTrackingSucceeded", AlltrackUtil.eventSuccessToMap(event));
    }

    @Override
    public void onFinishedEventTrackingFailed(AlltrackEventFailure event) {
        sendEvent(getReactApplicationContext(), "alltrack_eventTrackingFailed", AlltrackUtil.eventFailureToMap(event));
    }

    @Override
    public void onFinishedSessionTrackingSucceeded(AlltrackSessionSuccess session) {
        sendEvent(getReactApplicationContext(), "alltrack_sessionTrackingSucceeded", AlltrackUtil.sessionSuccessToMap(session));
    }

    @Override
    public void onFinishedSessionTrackingFailed(AlltrackSessionFailure session) {
        sendEvent(getReactApplicationContext(), "alltrack_sessionTrackingFailed", AlltrackUtil.sessionFailureToMap(session));
    }

    @Override
    public boolean launchReceivedDeeplink(Uri uri) {
        sendEvent(getReactApplicationContext(), "alltrack_deferredDeeplink", AlltrackUtil.deferredDeeplinkToMap(uri));
    ...
    public void create(ReadableMap mapConfig) {
        ...
        final AlltrackConfig alltrackConfig = new AlltrackConfig(getReactApplicationContext(), appToken, environment, isLogLevelSuppress);
        ...
        //     alltrackConfig.setReadMobileEquipmentIdentity(readMobileEquipmentIdentity);
        // }
        ...
        if (attributionCallback) {
            alltrackConfig.setOnAttributionChangedListener(this);
        }

        // Event tracking succeeded callback.
        if (eventTrackingSucceededCallback) {
            alltrackConfig.setOnEventTrackingSucceededListener(this);
        }

        // Event tracking failed callback.
        if (eventTrackingFailedCallback) {
            alltrackConfig.setOnEventTrackingFailedListener(this);
        }

        // Session tracking succeeded callback.
        if (sessionTrackingSucceededCallback) {
            alltrackConfig.setOnSessionTrackingSucceededListener(this);
        }

        // Session tracking failed callback.
        if (sessionTrackingFailedCallback) {
            alltrackConfig.setOnSessionTrackingFailedListener(this);
        }

        // Deferred deeplink callback.
        if (deferredDeeplinkCallback) {
            alltrackConfig.setOnDeeplinkResponseListener(this);
        }

        // Start SDK.
        com.alltrack.sdk.Alltrack.onCreate(alltrackConfig);
        com.alltrack.sdk.Alltrack.onResume();
    }
    ...
    public void trackEvent(ReadableMap mapEvent) {
        ...
        final AlltrackEvent event = new AlltrackEvent(eventToken);
        if (!event.isValid()) {
            return;
        }
        ...
        if (checkKey(mapEvent, "callbackParameters")) {
            callbackParameters = AlltrackUtil.toMap(mapEvent.getMap("callbackParameters"));
        ...
        if (checkKey(mapEvent, "partnerParameters")) {
            partnerParameters = AlltrackUtil.toMap(mapEvent.getMap("partnerParameters"));
        ...
        // Track event.
        com.alltrack.sdk.Alltrack.trackEvent(event);
    }

    @ReactMethod
    public void setEnabled(Boolean enabled) {
        com.alltrack.sdk.Alltrack.setEnabled(enabled);
    }

    @ReactMethod
    public void isEnabled(Callback callback) {
        callback.invoke(com.alltrack.sdk.Alltrack.isEnabled());
    }

    @ReactMethod
    public void setReferrer(String referrer) {
        com.alltrack.sdk.Alltrack.setReferrer(referrer, getReactApplicationContext());
    }

    @ReactMethod
    public void setOfflineMode(Boolean enabled) {
        com.alltrack.sdk.Alltrack.setOfflineMode(enabled);
    }

    @ReactMethod
    public void setPushToken(String token) {
        com.alltrack.sdk.Alltrack.setPushToken(token, getReactApplicationContext());
    }

    @ReactMethod
    public void appWillOpenUrl(String strUri) {
        final Uri uri = Uri.parse(strUri);
        com.alltrack.sdk.Alltrack.appWillOpenUrl(uri, getReactApplicationContext());
    }

    @ReactMethod
    public void sendFirstPackages() {
        com.alltrack.sdk.Alltrack.sendFirstPackages();
    }
    ...
    public void trackAdRevenue(String source, String payload) {
        try {
            ...
            com.alltrack.sdk.Alltrack.trackAdRevenue(source, jsonPayload);
    ...
    public void trackAdRevenueNew(ReadableMap mapAdRevenue) {
        ...
        final AlltrackAdRevenue adRevenue = new AlltrackAdRevenue(source);
        ...
        if (checkKey(mapAdRevenue, "callbackParameters")) {
            callbackParameters = AlltrackUtil.toMap(mapAdRevenue.getMap("callbackParameters"));
            if (null != callbackParameters) {
                for (Map.Entry<String, Object> entry : callbackParameters.entrySet()) {
        ...
        if (checkKey(mapAdRevenue, "partnerParameters")) {
            partnerParameters = AlltrackUtil.toMap(mapAdRevenue.getMap("partnerParameters"));
            if (null != partnerParameters) {
                for (Map.Entry<String, Object> entry : partnerParameters.entrySet()) {
        ...
        // Track ad revenue.
        com.alltrack.sdk.Alltrack.trackAdRevenue(adRevenue);
    }
    ...
    public void trackPlayStoreSubscription(ReadableMap mapEvent) {
        ...
        // Track subscription.
        com.alltrack.sdk.Alltrack.trackPlayStoreSubscription(subscription);
    }

    @ReactMethod
    public void addSessionCallbackParameter(String key, String value) {
        com.alltrack.sdk.Alltrack.addSessionCallbackParameter(key, value);
    }

    @ReactMethod
    public void addSessionPartnerParameter(String key, String value) {
        com.alltrack.sdk.Alltrack.addSessionPartnerParameter(key, value);
    }

    @ReactMethod
    public void removeSessionCallbackParameter(String key) {
        com.alltrack.sdk.Alltrack.removeSessionCallbackParameter(key);
    }

    @ReactMethod
    public void removeSessionPartnerParameter(String key) {
        com.alltrack.sdk.Alltrack.removeSessionPartnerParameter(key);
    }

    @ReactMethod
    public void resetSessionCallbackParameters() {
        com.alltrack.sdk.Alltrack.resetSessionCallbackParameters();
    }

    @ReactMethod
    public void resetSessionPartnerParameters() {
        com.alltrack.sdk.Alltrack.resetSessionPartnerParameters();
    }

    @ReactMethod
    public void gdprForgetMe() {
        com.alltrack.sdk.Alltrack.gdprForgetMe(getReactApplicationContext());
    }

    @ReactMethod
    public void disableThirdPartySharing() {
        com.alltrack.sdk.Alltrack.disableThirdPartySharing(getReactApplicationContext());
    }
    ...
    public void getGoogleAdId(final Callback callback) {
        com.alltrack.sdk.Alltrack.getGoogleAdId(getReactApplicationContext(), new com.alltrack.sdk.OnDeviceIdsRead() {
            @Override
    ...
    public void getAdid(Callback callback) {
        callback.invoke(com.alltrack.sdk.Alltrack.getAdid());
    }

    @ReactMethod
    public void getAmazonAdId(Callback callback) {
        callback.invoke(com.alltrack.sdk.Alltrack.getAmazonAdId(getReactApplicationContext()));
    }

    @ReactMethod
    public void getAttribution(Callback callback) {
        callback.invoke(AlltrackUtil.attributionToMap(com.alltrack.sdk.Alltrack.getAttribution()));
    }

    @ReactMethod
    public void getSdkVersion(String sdkPrefix, Callback callback) {
        String sdkVersion = com.alltrack.sdk.Alltrack.getSdkVersion();
        if (sdkVersion == null) {
            callback.invoke("");
        } else {
    ...
    public void trackThirdPartySharing(ReadableMap mapThirdPartySharing) {
        ...
        final AlltrackThirdPartySharing thirdPartySharing = new AlltrackThirdPartySharing(isEnabled);

        // Granular options.
        if (checkKey(mapThirdPartySharing, "granularOptions")) {
            granularOptions = AlltrackUtil.toList(mapThirdPartySharing.getArray("granularOptions"));
        ...
        if (checkKey(mapThirdPartySharing, "partnerSharingSettings")) {
            partnerSharingSettings = AlltrackUtil.toList(mapThirdPartySharing.getArray("partnerSharingSettings"));
        ...
        com.alltrack.sdk.Alltrack.trackThirdPartySharing(thirdPartySharing);
    }

    @ReactMethod
    public void trackMeasurementConsent(boolean measurementConsent) {
        com.alltrack.sdk.Alltrack.trackMeasurementConsent(measurementConsent);
    }
    ...
    public void setTestOptions(ReadableMap mapTest) {
        ...
        final AlltrackTestOptions testOptions = new AlltrackTestOptions();
        ...
        com.alltrack.sdk.Alltrack.setTestOptions(testOptions);
    }
