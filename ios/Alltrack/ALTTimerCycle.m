...
+ (ALTTimerCycle *)timerWithBlock:(dispatch_block_t)block
                     ...
                     intervalTime:(NSTimeInterval)intervalTime
                             name:(NSString*)name
{
    return [[ALTTimerCycle alloc] initBlock:block queue:queue startTime:startTime intervalTime:intervalTime name:name];
}
...

{
    ...
    NSString * startTimeFormatted = [ALTUtil secondsNumberFormat:startTime];
    NSString * intervalTimeFormatted = [ALTUtil secondsNumberFormat:intervalTime];
