#import "ALTLogger.h"
#import "ALTKeychain.h"
#import "ALTAlltrackFactory.h"
#include <dlfcn.h>

@implementation ALTKeychain

#pragma mark - Object lifecycle methods

+ (id)getInstance {
    static ALTKeychain *defaultInstance = nil;
...
+ (BOOL)setValue:(NSString *)value forKeychainKey:(NSString *)key inService:(NSString *)service {
    ...
    return [[ALTKeychain getInstance] setValue:value forKeychainKey:key inService:service];
}
...
+ (NSString *)valueForKeychainKey:(NSString *)key service:(NSString *)service {
    ...
    return [[ALTKeychain getInstance] valueForKeychainKey:key service:service];
}
...
- (BOOL)setValue:(NSString *)value forKeychainKey:(NSString *)key inService:(NSString *)service {
    ...
    if (status != noErr) {
        [[ALTAlltrackFactory logger] warn:@"Value unsuccessfully written to the keychain"];
        return NO;
    } else {
        ...
        if (wasSuccessful) {
            [[ALTAlltrackFactory logger] warn:@"Value successfully written to the keychain"];
        }
