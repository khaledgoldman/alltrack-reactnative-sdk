...
@interface AlltrackTestOptions : NSObject
 ...
 */
extern NSString * __nonnull const ALTEnvironmentSandbox;
extern NSString * __nonnull const ALTEnvironmentProduction;

/**
 * Constants for supported ad revenue sources.
 */
extern NSString * __nonnull const ALTAdRevenueSourceAppLovinMAX;
extern NSString * __nonnull const ALTAdRevenueSourceMopub;
extern NSString * __nonnull const ALTAdRevenueSourceAdMob;
extern NSString * __nonnull const ALTAdRevenueSourceIronSource;
extern NSString * __nonnull const ALTAdRevenueSourceAdMost;
extern NSString * __nonnull const ALTAdRevenueSourceUnity;
extern NSString * __nonnull const ALTAdRevenueSourceHeliumChartboost;
extern NSString * __nonnull const ALTAdRevenueSourcePublisher;

/**
 * Constants for country app's URL strategies.
 */
extern NSString * __nonnull const ALTUrlStrategyIndia;
extern NSString * __nonnull const ALTUrlStrategyChina;
extern NSString * __nonnull const ALTUrlStrategyCn;
extern NSString * __nonnull const ALTDataResidencyEU;
extern NSString * __nonnull const ALTDataResidencyTR;
extern NSString * __nonnull const ALTDataResidencyUS;

/**
 * @brief The main interface to Alltrack.
 *
 * @note Use the methods of this class to tell Alltrack about the usage of your app.
 *       See the README for details.
 */
@interface Alltrack : NSObject

/**
 * @brief Tell Alltrack that the application did launch.
 *        This is required to initialize Alltrack. Call this in the didFinishLaunching
 *        method of your AppDelegate.
 *
 * @note See ALTConfig.h for more configuration options
 *
 * @param alltrackConfig The configuration object that includes the environment
 ...
 */
+ (void)appDidLaunch:(nullable ALTConfig *)alltrackConfig;

/**
 * @brief Tell Alltrack that a particular event has happened.
 *
 * @note See ALTEvent.h for more event options.
 *
 * @param event The Event object for this kind of event. It needs a event token
 *              that is created in the dashboard at http://alltrack.com and should be six
 *              characters long.
 */
+ (void)trackEvent:(nullable ALTEvent *)event;

/**
 * @brief Tell alltrack that the application resumed.
 *
...
/**
 * @brief Tell alltrack that the application paused.
 *
 * @note Only necessary if the native notifications can't be used.
 */
...
/**
 * @brief Enable or disable the alltrack SDK. This setting is saved for future sessions.
 *
 * @param enabled The flag to enable or disable the alltrack SDK.
 */
...
/**
 * @brief Read the URL that opened the application to search for an alltrack deep link.
 *
 * @param url URL object which contains info about alltrack deep link.
 */
...
/**
 * @brief Set the device token used by push notifications.
 *        This method is only used by Alltrack non native SDKs. Don't use it anywhere else.
 *
...
/**
 * @brief Get current alltrack identifier for the user.
 *
 * @note Alltrack identifier is available only after installation has been successfully tracked.
 *
 * @return Current alltrack identifier value for the user.
 */
 ...
 */
+ (nullable ALTAttribution *)attribution;

/**
 * @brief Get current Alltrack SDK version string.
 *
 * @return Alltrack SDK version string (iosX.Y.Z).
 */
...
/**
 * @brief Tell the alltrack SDK to stop waiting for delayed initialisation timer to complete but rather to start
 *        upon this call. This should be called if you have obtained needed callback/partner parameters which you
 *        wanted to put as default ones before the delayedStart value you have set on ALTConfig has expired.
 */
+ (void)sendFirstPackages;

/**
 * @brief Tell alltrack to send the request to Google and check if the installation
 ...
 */
+ (void)trackAdRevenue:(nonnull ALTAdRevenue *)adRevenue;
...
/**
 * @brief Alltrack wrapper for requestTrackingAuthorizationWithCompletionHandler: method.
 *
...
/**
 * @brief Alltrack wrapper for SKAdNetwork's updateConversionValue: method.
 *
...
/**
 * @brief Alltrack wrapper for SKAdNetwork's updatePostbackConversionValue:completionHandler: method.
 *
 * @param conversionValue Conversion value you would like SDK to set for given user.
...
/**
 * @brief Alltrack wrapper for SKAdNetwork's updatePostbackConversionValue:coarseValue:completionHandler: method.
 *
...
/**
 * @brief Alltrack wrapper for SKAdNetwork's updatePostbackConversionValue:coarseValue:lockWindow:completionHandler: method.
 *
 * @param fineValue Conversion value you would like SDK to set for given user.
 * @param coarseValue One of the possible SKAdNetworkCoarseConversionValue values.
...
/**
 * @brief Instruct to Alltrack SDK to check current state of att_status.
 */
 ...
 */
+ (void)setTestOptions:(nullable AlltrackTestOptions *)testOptions;

/**
 * Obtain singleton Alltrack object.
 */
