...
/**
 * @brief Alltrack event class.
 */
@interface ALTEvent : NSObject<NSCopying>
 ...
 *                   at http://alltrack.com and should be six characters long.
 */
+ (nullable ALTEvent *)eventWithEventToken:(nonnull NSString *)eventToken;
 ...
 *
 * @note In your dashboard at http://alltrack.com you can assign a callback URL to each
...
/**
 * @brief Check if created alltrack event object is valid.
 *
 * @return Boolean indicating whether the alltrack event object is valid or not.
 */
- (BOOL)isValid;
 ...
 *       For more information, visit: https://github.com/alltrack/ios_purchase_sdk
 */
