...
@implementation ALTActivityPackage
...
- (NSString *)description {
    return [NSString stringWithFormat:@"%@%@", [ALTActivityKindUtil activityKindToString:self.activityKind], self.suffix];
}

- (NSString *)successMessage {
    return [NSString stringWithFormat:@"Tracked %@%@", [ALTActivityKindUtil activityKindToString:self.activityKind], self.suffix];
}

- (NSString *)failureMessage {
    return [NSString stringWithFormat:@"Failed to track %@%@", [ALTActivityKindUtil activityKindToString:self.activityKind], self.suffix];
}
...
- (id)initWithCoder:(NSCoder *)decoder {
    ...
    self.activityKind = [ALTActivityKindUtil activityKindFromString:kindString];

    return self;
}

- (void)encodeWithCoder:(NSCoder *)encoder {
    NSString *kindString = [ALTActivityKindUtil activityKindToString:self.activityKind];
